...
app.get('/supplier', function (req, res) {
    ...
    var objToJson = {
        purpose: "Supplier Endpoint"
    };
    res.setHeader('content-type', 'text/javascript');
    res.send(objToJson);
});

http.listen(10016, function () {
    console.log('Listening on *:10016');
    console.log('http://localhost:10016/');
    console.log('http://localhost:10016/supplier');
});
...
var service = "microservice-supplier-rest";
...
var kvValue = {
    ...
    "dependencies": [{
        ...
        {
            "name": "microservice-product-rest",
            "version": "1.0"
        },
        {
            "name": "inventory-rest",
